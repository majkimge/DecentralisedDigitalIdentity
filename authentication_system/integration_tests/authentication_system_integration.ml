...
let%expect_test "Pembroke_test" =
  ...
  let fellow_attribute = System.Node.attribute "Fellow" System.Node.Never in
  ...
  let system =
    System.grant_attribute system ~agent:admin ~from:anil ~to_:fellow_attribute
  in
...
let%expect_test "Ticketing_test" =
  ...
  let college_handler = System.Node.attribute_handler "College_handler" Never in
  let system =
    System.add_attribute_handler_under_agent system
  ...
  in
  let postdoc_attr =
    System.get_attribute_by_id system (System.Node.attribute_id "Postdoc")
  in
  let professor_attr =
    System.get_attribute_by_id system (System.Node.attribute_id "Professor")
  in
  let student_attr =
    System.get_attribute_by_id system (System.Node.attribute_id "Student")
  in
...
let%expect_test "Trim_test" =
  ...
  let system = System.trim system [ System.node_to_any main_site ] in

  print_string (Yojson.to_string (System.to_json system));
  [%expect
    {|
    {"position_tree":{"nodes":[{"id":"world","group":"resource","is_extension":false},{"id":"main_site","group":"resource","is_extension":false},{"id":"admin","group":"agent","is_extension":false}],"links":[{"source":"world","target":"main_site","type":"simple"},{"source":"world","target":"admin","type":"simple"}]},"permission_dag":{"nodes":[{"id":"admin","group":"agent","is_extension":false},{"id":"Anil","group":"agent","is_extension":false},{"id":"world","group":"resource","is_extension":false},{"id":"Pembroke","group":"resource_handler","is_extension":false},{"id":"main_site","group":"resource","is_extension":false}],"links":[{"source":"admin","target":"Pembroke","type":"simple"},{"source":"admin","target":"world","type":"simple"},{"source":"Anil","target":"main_site","type":"simple"},{"source":"Anil","target":"world","type":"simple"},{"source":"world","target":"main_site","type":"simple"},{"source":"world","target":"Pembroke","type":"simple"},{"source":"Pembroke","target":"main_site","type":"simple"}]}} |}]
